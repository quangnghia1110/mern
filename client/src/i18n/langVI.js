...
export default {
  ...
  home: {
    'page-title': 'Điện thoại di dộng chính hãng và phụ kiện | 3TNL Mobile',
    cart: 'Giỏ hàng',
  ...
  account: {
    'page-title': 'Account | 3TNL Mobile',
  ...
  cart: {
    'page-title': 'Giỏ hàng | 3TNL Mobile',
    title: 'Giỏ hàng',
  ...
  order: {
    'page-title': 'Đơn hàng | 3TNL Mobile',
    'dashboard-page-title': 'Quản lý Đơn hàng | 3TNL Mobile',
  ...
  auth: {
    'page-title': {
      login: 'Đăng nhập | 3TNL Mobile',
      register: 'Đăng ký | 3TNL Mobile',
      'reset-password': 'Đặt lại mật khẩu | 3TNL Mobile'
    },
    ...
    'accept-terms': 'Khi đăng ký, bạn đã đồng ý với 3TNL Mobile về',
    tos: 'Điều khoản sử dụng',
    'privacy-policy': 'Chính sách bảo mật',

    'register-salutation': 'Gia nhập 3TNL Mobile ngay hôm nay',
  ...
  dashboard: {
    ...
    'updated-at': 'Ngày sửa',
    categories: {
      'page-title': 'Quản lý Danh mục | 3TNL Mobile',
    ...
    brands: {
      'page-title': 'Quản lý Thương hiệu | 3TNL Mobile',
      title: 'Thương hiệu',
    ...
    discounts: {
      'page-title': 'Quản lý Giảm giá | 3TNL Mobile',
      title: 'Khuyến mãi',
    ...
    users: {
      'page-title': 'User management | 3TNL Mobile',
      title: 'Người dùng',
  ...
  products: {
    fee: 'Giá liên hệ',
    'page-title': 'Quản lý sản phẩm | 3TNL Mobile',
    title: 'Sản phẩm',
    ...
    save: 'Lưu lại',
    'add-title': 'Ecommerce: Add new product | 3TNL Mobile',
    'add-success': 'Thêm sản phẩm mới thành công',
    edit: 'Chỉnh sửa sản phẩm',
    'edit-title': 'Ecommerce: Edit new product | 3TNL Mobile',
    delete: 'Xóa sản phẩm',
    ...
    'infor-1-content': 'Tất cả các sản phẩm tại 3TNL Mobile đều là hàng chính hãng tại Việt Nam',
